...
(function (ShapeFlags) {
    ...
    ShapeFlags[ShapeFlags["KEEP_ALIVE_COMPONENT"] = 32] = "KEEP_ALIVE_COMPONENT";
...
const KeepAlive = {
    __isKeepAlive: true,
    name: "KeepAlive",
    __injectPatch__(patchFn) {
    },
    setup() {
        // console.log("keep-alive的setup执行");
        const curInstance = getCurrentInstance();
        curInstance.parent;
        curInstance.activate = (vnode, container, anchor) => {
...
function createRender(options) {
        ...
        if (n2.props && n2.props["v-for"]) {
            ...
            for (let i = 0; i < listVal.length; i++) {
                ...
                const vnode = {
                    ...
                    props: {},
                    children: child,
                    shapeFlag: ShapeFlags.ELEMENT | // 标记为元素节点 [!code ++]
                        (typeof child === "string"
    ...
    function processComponent(n1, n2, container, parentComponent, anchor) {
        if (!n1 || n1.type !== n2.type) {
            ...
            const isCachedKeepAlive = n2.KeepAliveInstance &&
    ...
    function setupRenderEffect(n1, instance, n2, container, anchor) {
        instance.update = effect(() => {
            var _a;
            //首次渲染
            console.log("正在执行 render 的组件是:", (_a = instance.type) === null || _a === void 0 ? void 0 : _a.name);
    ...
    function patchChildren(n1, n2, container, parentComponent, anchor) {
        ...
        // **新 children 不是文本（即新的 children 是数组或空）**
            ...
            if (prevShapeFlag & ShapeFlags.TEXT_CHILDREN) {
                ...
                //array diff array
                patchKeyedChildren(Array.isArray(c1) ? c1 : [], Array.isArray(c2) ? c2 : [], container, parentComponent, anchor);
            }
        }
    }
...
export { KeepAlive, createApp, createElement, createVNode as createElementVNode, createRender, createTextVNode, getCurrentInstance, h, inject, insert, nextTick, pathProp, provide, proxyRefs, ref, registerRuntimeCompiler, remove, renderSlots, setElement, toDisplayString };
